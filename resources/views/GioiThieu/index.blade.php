...
<div class="about-container">
    ...
    <div class="text-column">
        ...
        <p>Thiện Tâm Medical là một website cung cấp thuốc và tư vấn y tế trực tuyến, là đồ án môn học thực hành web và ứng dụng tại Trường Đại học Công nghệ Sài Gòn.</p>
        ...
        <ul>
            ...
            <li>Cập nhật số lượng và giá tiền ở giỏ hàng  </li>
            <li>Trang chi tiết giỏ hàng </li>
            <li>Chức năng hiển thị sản phẩm theo danh mục</li>
            <li>Chức năng hiển thị chi tiết sản phẩm </li>
            <li>Carousel tin tức </li>
            <li>Hiệu ứng di chuyển đến header 2 </li>
            <li>AI CHAT box </li>
            <li>back to top </li>
            <li>Slider hình ảnh sản phẩm </li>
            <li>Slider Quảng cáo</li>
            <li>Map</li>
            ...
            <li>Kiểm tra form và hiện modal thành công khi nhập form hợp lệ </li>
        </ul>
    </div>
</div>
